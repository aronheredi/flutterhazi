...
import 'package:flutter_homework_24_2/main.dart';
import 'package:flutter_homework_24_2/network/user_item.dart';
  ...
  group('Has correct network communication', () {
    ...
    group('No saved token', () {
      ...
      testWidgets(
        ...
        (tester) async => mockNetworkImages(
          () async {
            ...
            var tokenKey = verify(() =>
                    GetIt.I<SharedPreferences>().getString(captureAny()))
                .captured
                .first as String;
            verify(() =>
      ...
      group('Has saved token', () {
        ...
        testWidgets(
          'Sign out works on ListPage [3]',
          (tester) async => mockNetworkImages(
            () async {
              when(() => GetIt.I<SharedPreferences>().remove(any()))
                  .thenAnswer((_) async => true);
              await tester.pumpWidget(const MyApp());
              await tester.pumpAndSettle();
              ...
              expect(route.settings.name, '/');
              verify(() => GetIt.I<SharedPreferences>().remove(any()));
            },
          ),
        );
      });
